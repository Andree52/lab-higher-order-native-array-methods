...
function findPinkElephantsByTimestreet(songs) {
  const pinkElephantsSong = songs.find(
    song => song.title === "Pink Elephants" && song.artist === "Timestreet"
  );
...
function findFirstSongUnderThreeMinutes(songs) {
  const firstSongUnderThreeMinutes = songs.find(song => song.runtime < 180);
